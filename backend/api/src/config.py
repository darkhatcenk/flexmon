...
class Settings(BaseSettings):
    ...
    # Database Configuration - discrete vars
    ...
    # Full DATABASE_URL (optional, takes precedence if set)
    ...
    def get_database_url(self) -> str:
        """Get database URL, building from parts if not explicitly set"""
    ...
    cors_origins: list[str] = Field(
        default=["http://localhost:3000", "https://localhost:3000", "http://localhost:8000"],
